// Catalogue de connecteurs Lenexux.
// Statuts HONNÊTES :
...
//               du fournisseur (CSV/JSON) et Lenexux le normalise — fonctionne dès
...
export const CONNECTORS: Connector[] = [
  ...
  { id: 'rest', name: 'REST / API JSON (live)', category: 'files', authType: 'apikey', tier: 'active', glyph: '{ }', descFr: 'Pointez une API renvoyant du JSON : pull LIVE, détection des colonnes, ingestion via le pipeline. Rend exploitable toute source dotée d’une API.', descEn: 'Point to a JSON API: LIVE pull, column detection, pipeline ingestion. Makes any API-backed source usable.', bringsFr: 'Entités & relations, en direct', bringsEn: 'Entities & relations, live', docUrl: 'https://www.json.org/' },
  ...
  // ---- IA & MCP ----
  { id: 'mcp-server', name: 'Serveur MCP Lenexux', category: 'ai', authType: 'apikey', tier: 'active', glyph: 'MCP', descFr: 'Exposez Lenexux comme serveur MCP : Claude interroge le graphe et lance des simulations.', descEn: 'Expose Lenexux as an MCP server: Claude queries the graph and runs simulations.', bringsFr: 'Requêtes graphe, risques, what-if', bringsEn: 'Graph queries, risks, what-if', docUrl: 'https://modelcontextprotocol.io/' },
