  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1" style={{ fontSize: 13, color: 'var(--nx-text-muted)' }}>{t('Importez ou collez des runbooks, notes d’incident ou documents d’architecture — Lenexux en extrait les dépendances et risques, recoupés avec votre graphe en direct.', 'Upload or paste runbooks, incident notes or architecture docs — Lenexux extracts the dependencies and risks they reference against your live graph.')}</p>
      </div>
