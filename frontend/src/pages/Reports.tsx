    ...
    <div className="relative w-full max-w-4xl overflow-hidden rounded-lg border shadow-2xl" style={{ background: 'var(--nx-surface)', borderColor: 'var(--nx-border)' }}>
      ...
      <header className="flex items-end justify-between border-b p-8" style={{ borderColor: 'var(--nx-border)', background: 'var(--nx-panel)' }}>
        <div>
          ...
          <h2 style={{ fontFamily: geist, fontSize: 28, fontWeight: 600, color: 'var(--nx-text)', lineHeight: 1.1 }}>{t('RAPPORT STRATÉGIQUE', 'Lenexux STRATEGIC')}<br />{t('DE RÉSILIENCE Lenexux', 'RESILIENCE REPORT')}</h2>
        </div>
      ...
      <div className="space-y-10 p-8">
        ...
        <div className="border-t pt-4 text-center" style={{ borderColor: 'var(--nx-border)', fontFamily: mono, fontSize: 10, color: 'var(--nx-text-muted)' }}>
          {t('Lenexux — Intelligence opérationnelle des dépendances · Confidentiel', 'Lenexux — Operational Dependency Intelligence · Confidential')}
        </div>
      </div>
    </div>
  )
