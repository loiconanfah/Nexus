      ...
      <div className="mx-auto flex max-w-6xl gap-8 px-6 py-8">
        ...
        <main className="flex min-w-0 flex-1 flex-col gap-10" style={{ lineHeight: 1.6 }}>
          ...
          <Sec id="documents" title="Documents (extraction)">
            <P>Importez un document <b>Word (.docx)</b>, un classeur <b>Excel (.xlsx)</b>, un <b>PDF</b>, un <b>CSV</b> ou du texte, ou collez-le. Les tableaux et les feuilles sont lus ligne par ligne, chaque ligne devenant une phrase complète. Les lignes structurées (identifiant et nom, ou source, relation et cible) sont lues <b>exactement, sans IA</b> : un classeur de centaines d’éléments et de liens est repris en entier, identique d’une analyse à l’autre, sans consommer de quota. Le document est découpé en sections : l’IA relève d’abord les éléments et les risques de chaque section, puis cherche les liens en connaissant <b>tous</b> les éléments du document, pour relier une phrase d’une section à un élément nommé dans une autre.</P>
