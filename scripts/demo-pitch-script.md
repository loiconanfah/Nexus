# Démo Lenexux — Pitch investisseurs (~75 s)
...
| 8–14 s | Graphe de dépendances | « Lenexux cartographie tout — systèmes, fournisseurs, personnes — en un seul graphe vivant. » | “Lenexux maps it all — systems, suppliers, people — into a single living graph.” |
| 14–26 s | Impact transversal (question → résultat) | « Posez une question en langage naturel : *que se passe-t-il si nous perdons ce fournisseur ?* En une seconde, Lenexux relie les silos et chiffre l'impact : vingt composants menacés, plus de trois millions exposés, et le point unique de défaillance identifié. » | “Ask in plain language: *what happens if we lose this supplier?* In one second, Lenexux links the silos and quantifies the impact: twenty components at risk, over three million exposed, and the single point of failure pinpointed.” |
...
| 60–75 s | Vitrine (clôture) | « Lenexux : savoir ce qui casse, avant que l'activité n'en pâtisse. » | “Lenexux: know what breaks, before the business does.” |
...
- **Clip Inférence** (page Dépendances inférées) : « Un graphe qui apprend :
  Lenexux propose les dépendances manquantes, vous validez. »
