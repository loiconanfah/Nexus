...
public static class DocumentAnalyzer
{
    ...
    public static string SystemPrompt(string lang)
    {
        ...
        return
            ...
            "7 quinquies. Un identifiant (APP-CORE-01, PER-002, UNI-RIS, SRV-007) n'est JAMAIS un élément et ne doit JAMAIS servir de name : c'est un alias de l'élément nommé sur la même ligne. Le name est le libellé lisible par un humain (« Core banking FiadBank »), l'identifiant va dans aliases. Si une ligne ne porte qu'un identifiant sans libellé, ne crée rien.\n" +
